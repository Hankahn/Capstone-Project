...
import com.essentialtcg.magicthemanaging.data.loaders.SetLoader;
import com.essentialtcg.magicthemanaging.data.transforms.SetTransform;
    ...
    private class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (mSearchParameters.getSetFilter() != null &&
                    mSearchParameters.getSetFilter().containsSetItem(setItem)) {
